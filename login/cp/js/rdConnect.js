var rdConnect = (function () {
  ...
  return function (co) {
    ...
    var initRedirect = function () {
      if (redirect_url == undefined) {
        ...
        if (cDynamicData != undefined) {
          //We had to add this since it is not always populated by the time this is run
    ...
    var coovaRefresh = function (do_usage_also) {
      if (typeof do_usage_also === "undefined") {
        do_usage_also = false;
      } //By default we give feedback
    ...
    var showOverlay = function () {
      $$("layoutConnect").showOverlay(
        '<div style="background-color: grey; opacity: 0.5; height:100%; width: 100%; margin:0px;padding:0px;"></div>',
      );
    };
    ...
    var onBtnConnectClick = function () {
      ...
      if ($$("voucher") != undefined) {
        //This means the voucher controll is there
        voucher_present = true;
      }

      if ($$("Username") != undefined) {
        //This means the user controll is there
        user_present = true;
      }
      ...
      if ($$("Username") != undefined) {
        if (auto_suffix_check && $$("Username").getValue().length != 0) {
    ...
    var login = function (encPwd) {
      showFeedback(
        i18n("sLog") + " " + userName + " " + i18n("sinto_Captive_Portal"),
      );
      var urlLogin = "";
      var ajax = {};
      if (isMikroTik) {
    ...
    var onBtnClickRegister = function () {
      webix.rules.intNumber = function (val) {
        return /^(\d{8})|(\d{9})|(\d{10})|(\d{11})|(\d{12})|(\d{13})$/.test(
          val,
        );
      };
            ...
            elements: [
              {
                ...
                template:
                  "<h3>" +
                  i18n("sSign_dash_up_for_free_Internet") +
                  "</h3>" +
                  i18n("sWelcome_to_free_Wi_dash_Fi_by") +
                  " <b>" +
                  cDynamicData.detail.name +
                  "</b>.<br>" +
                  i18n("sSign_dash_up_once_to_get_Internet_access") +
                  "!<br>",
              },
              {
                view: "text",
              ...
              },
              {
                ...
                click: function () {
                  ...
                  if (this.getParentView().validate()) {
                      ...
                      .post(
                        ...
                        function (text, data, xhr) {
                          if (data.json().success == true) {
                            ...
                            if (data.json().errors) {
                              var error_string = "";
                              Object.keys(data.json().errors).forEach(
                                function (key) {
                            ...
                            webix.message({
                              type: "error",
                              text: i18n("sCould_not_register_user"),
                            });
                          }
                        },
                      );
                    ...
                    webix.message({
                      type: "error",
                      text: i18n("sForm_data_is_invalid"),
                    });
                },
              },
            ],
            ...
            cols: [
              {
                ...
                template:
                  "<h3>" +
                  i18n("sSupply_your_email_address") +
                  "</h3>" +
                  i18n("sIf_you_are_registered_with_us") +
                  "<br>" +
                  ...
                  },
                  {
                    ...
                    click: function () {
                      if (this.getParentView().validate()) {
                        ...
                        var auto_suffix_check =
                          cDynamicData.settings.auto_suffix_check;
                        var auto_suffix = cDynamicData.settings.auto_suffix;

                        this.getParentView().setValues(
                          {
                          ...
                          .post(
                            ...
                            function (text, data, xhr) {
                              if (data.json().success == true) {
                                ...
                                webix.message({
                                  type: "error",
                                  text: i18n("sCould_not_email_password"),
                                });
                              }
                            },
                          );
            ...
            cols: [
              {
                ...
                template:
                  "<h3>" +
                  i18n("sAction_complete") +
                  "!</h3>" +
                  i18n("sPlease_check_your_email") +
                  "<br>",
              },
            ],
          },
        ...
        head: {
          ...
          cols: [
            { view: "label", label: i18n("sLost_Password"), align: "center" },
            {
              ...
              width: 70,
              click:
                "$$('pwdMulti').setValue('pwdForm'); $$('pwdNext').hide();",
            },
            {
              view: "icon",
              icon: "wxi-close",
