var sConnectSimple = (function () {
  ...
  return function (co) {
    ...
    var translateHotspotMessage = function (msg) {
      ...
      if (
        msg.indexOf("Sorry... you have used your") > -1 &&
        msg.indexOf("data allowance") > -1
      ) {
      ...
      if (msg.indexOf("Missing Cleartext Password For") === 0) {
        ...
        if (translated != undefined) {
          return (
            translated + msg.substring("Missing Cleartext Password For".length)
          );
        }
      }
      ...
      if (msg.indexOf("Not Available To Use On") > -1) {
        ...
        if (translated != undefined) {
          return (
            translated +
            msg.substring(
              msg.indexOf("Not Available To Use On") +
                "Not Available To Use On".length,
            )
          );
        }
      }
    ...
    var onBtnClickToConnectClickPre = function (event) {
      ...
      if (cDynamicData.settings.click_to_connect.cust_info_check == false) {
        ...
        $.ajax({
          ...
          dataType: "json",
          timeout: 3000,
          data: { mac: mac_address, nasid: nasid },
        })
          .done(function (j) {
            if (j.success == true) {
