var sDynamic = (function () {
  ...
  return function (co) {
    ...
    cDynUrl =
      ...
      "/cake4/rd_cake/dynamic-details/info-for.json";
    cAjaxTimeout = 3000;
          ...
          if (j.success == true) {
            ...
            Object.keys(j.data).forEach((key) => {
              ...
              if (stripe) {
                item_string =
                  item_string +
                  '<div style="background:#d2d4d4;font-size:12px;">' +
                  key +
    ...
    var guiHeader = function () {
      if (cDynamicData.settings.show_name) {
        ...
        $("#aTitle").attr(
          "style",
          "color:#" + cDynamicData.settings.name_colour + ";",
        );
      }
      ...
      if (
        ...
        var $nav_links = `   
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" data-bs-toggle="tab" data-bs-target="#nav-voucher" href="#"><i class="bi-ticket"></i> <span data-translate="sVoucher">Voucher</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-user" href="#"><i class="bi-person"></i> <span data-translate="sUser">User</span></a>
                    </li>
                </ul>`;
        ...
        var $nav_content =
          `
                <div class="tab-content p-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-voucher" role="tabpanel" aria-labelledby="nav-voucher-tab">
          ...
          i18n("sVoucher") +
          `" class="form-control" id="txtVoucher">
                            </div>
                        </div>                 
                    </div>
      ...
      cDynamicData.photos.forEach(function (i, j, k) {
        ...
        if (i.include_title && !i.include_description) {
          if (cDynamicData.settings.show_logo) {
            t_and_d =
              '<div class="carousel-caption"><img src="' +
              cDynamicData.detail.icon_file_name +
              '"/><h5>' +
              i.title +
              "</h5></div>";
            logo_included = true;
            ...
            t_and_d =
              '<div class="carousel-caption"><h5>' + i.title + "</h5></div>";
          }
        }
        if (!i.include_title && i.include_description) {
          if (cDynamicData.settings.show_logo) {
        ...
        if (i.fit == "dynamic") {
          ...
          if (scrn == "landscape" && i.layout == "landscape") {
            if (window.innerWidth < i.width) {
              //Small Graphic
              imgFit = "imgX";
            }

            if (window.innerWidth < i.width && i.width > 2000) {
              //Big graphic
              imgFit = "imgY";
            }
        ...
        if (j == 0) {
          $indicator.append(
            '<button type="button" data-bs-target="#crslMain" data-bs-slide-to="' +
              j +
